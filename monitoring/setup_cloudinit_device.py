...
iface {BRIDGE_NAME} inet static
    ...
    post-up iptables -t nat -A POSTROUTING -s {TARGET_NETWORK} -o vmbr0 -j MASQUERADE
    post-up iptables -A FORWARD -s {TARGET_NETWORK} -o vmbr0 -j ACCEPT
    post-up iptables -A FORWARD -d {TARGET_NETWORK} -i vmbr0 -m state --state RELATED,ESTABLISHED -j ACCEPT
'''
