...
$url = "$base_url/api2/json/nodes/$node/qemu/$vmId";
...
if (!$response) {
    logError("cURL error while deleting VM ID $vmId on node $node.");
...
jsonResponse(true, "VM is being deleted.", null);
logInfo("VM ID=$vmId deleted");
?>
