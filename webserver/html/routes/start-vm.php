...
$url = "$base_url/api2/json/nodes/$node/qemu/$vmId/status/start";
...
if (!$response) {
    logError("cURL error while starting VM ID $vmId on node $node.");
...
jsonResponse(true, "VM startup initiated.", null);
logInfo("VM ID=$vmId startup initiated.");
?>
