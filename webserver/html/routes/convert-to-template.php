...
$url = "$base_url/api2/json/nodes/$node/qemu/$vmId/template";
...
if (!$response) {
    logError("cURL error while converting VM ID $vmId on node $node.");
...
jsonResponse(true, "VM is getting converted.", null);
logInfo("VM ID=$vmId converted");
?>
